                        ...
                        <Drawer open={associationDetailDrawerOpen} onClose={() => { setAssociationDetailDrawerOpen(false) }} anchor='right' >
                            ...
                            <Grid container direction='column' alignItems='center' justifyContent='space-between' sx={{ p: 3 }}>
                                ...
                                <Grid container direction='row' alignItems='center' justifyContent='space-between'>
                                    ...
                                    <Grid item>
                                        <Typography sx={{ color: '#444', fontSize: 12, textAlign: 'left' }}>Address</Typography>
                                        <Typography sx={{ ml: 0.5, my: 1, color: '#444', fontSize: 13, fontWeight: 'bold', textAlign: 'left' }}>{selectedAssociation && selectedAssociation.address}</Typography>
                                    </Grid>
                                </Grid>
